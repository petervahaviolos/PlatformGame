...
public class TileMapRenderer {
    ...
    */
    public void draw(Graphics2D g, TileMap map,
        int screenWidth, int screenHeight, int lives, int score, int level, int time)
    {
        ...
        //draw time
        g.drawString("Time: " + time, 10, 100);
        
        //draw controls
        g.drawString("'Arrow Keys' to move", screenWidth - 235, 25);
        g.drawString("'Spacebar' to jump", screenWidth - 235, 50);
        g.drawString("'S' to suicide", screenWidth - 235, 75);
        g.drawString("'ESC' to quit", screenWidth - 235, 100);
